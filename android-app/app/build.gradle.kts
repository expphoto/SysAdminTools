...
android {
    ...
    defaultConfig {
        ...
        minSdk = 26  // Android 8.0 (required for AudioRecord improvements)
        targetSdk = 34
        versionCode = 1
        versionName = "1.0.0"
        ...
        // Server configuration (change to your backend URL)
    ...
    buildTypes {
        ...
        debug {
            ...
            buildConfigField("String", "SERVER_URL", "\"ws://192.168.1.100:8000\"")
...
dependencies {
    ...
    // Audio processing
    // Note: Opus codec requires native libraries - add via JitPack or local JNI
